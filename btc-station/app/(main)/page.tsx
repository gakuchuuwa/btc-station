...
function W_GaugeFng({ fg, large }: { fg: MacroData['fear_greed'] | undefined; large?: boolean }) {
  ...
  const desc = v <= 25 ? <>市场存在极度恐慌情绪，通常意味着投资者反应过度，<br/>往往是历史级别的买入机会。</> 
             : v <= 45 ? <>市场情绪悲观，投资者趋于保守。<br/>这可能预示短期调整，也可能在酝酿反弹动能。</> 
             : v <= 55 ? <>多空情绪基本平衡，无明显单边倾向。<br/>建议保持观望，等待明确的趋势信号确立。</> 
             : v <= 75 ? <>市场情绪高涨，买盘活跃。<br/>需逐渐警惕追高风险，可能正在接近阶段性的顶部。</> 
             : <>市场处于极度贪婪状态，极易发生剧烈的下杀回调。<br/>建议获利了结或严格设置止损。</>
