  ...
  const groups: { title: string; rows: { label: string; value: string; color?: string }[] }[] = [
    {
      ...
      rows: [
        ...
        { label: "最大回撤(浮动)",  value: fmtPct(-Math.abs(s.max_drawdown_pct ?? 0)), color: downColor },
        { label: "最大回撤(结算)",  value: s.closed_max_drawdown_pct != null ? fmtPct(-Math.abs(s.closed_max_drawdown_pct)) : "—", color: downColor },
